...
namespace TheoSynth
{
    public class Plugin : VstPluginBase
    {
        private readonly SineSynth _sineSynth;

        public Plugin()
            : base("Simple Sine Synth", new VstProductInfo("Simple Sine", "MyCompany", 1000), VstPluginFlags.NoFlags)
        {
        ...
        public Plugin() : base("Simple Sine Synth", new VstProductInfo("Simple Sine", "MyCompany", 1000), VstPluginFlags.NoFlags)
        {
            _sineSynth = new SineSynth();
